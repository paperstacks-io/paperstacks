...
func AddRoute(
	...
	mux.Handle(http.MethodGet+" /stacks/detail/{stackUUID}/papers/{paperUUID}/citation", authenticated(handleStacksPaperCitation(logger, tmpl, paperService, stackService, citationStyles)))
