...
import "github.com/paperstacks.io/paperstacks/internal/domain_"

type CreatePaperRequest struct {
	DOI                        string           `json:"DOI"`
	Title                      string           `json:"title"`
	TitleShort                 string           `json:"title-short"`
	Authors                    []domain_.Author `json:"authors"`
	...
	Metadata                   domain_.Metadata `json:"metadata"`
}
...
func (r CreatePaperRequest) ToDomain() domain_.Paper {
	return domain_.Paper{
		DOI:                        r.DOI,
		Title:                      r.Title,
...
func (r UpdatePaperRequest) ToDomain() domain_.Paper {
	return domain_.Paper{
		DOI:                        r.DOI,
		Title:                      r.Title,
		TitleShort:                 r.TitleShort,
...
func paperToResponse(p domain_.Paper) PaperResponse {
...
func papersToResponse(papers []domain_.Paper) []PaperResponse {
