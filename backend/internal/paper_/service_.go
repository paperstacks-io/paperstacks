...
func (r *Service) ReadAll() ([]domain_.Paper, error) {
	return r.paperRepo.ReadAll()
}

func (r *Service) Read(id string) (domain_.Paper, error) {
...
func (r *Service) Create(paper domain_.Paper) error {
	return r.paperRepo.Create(paper)
}

func (r *Service) Update(id string, paper domain_.Paper) error {
