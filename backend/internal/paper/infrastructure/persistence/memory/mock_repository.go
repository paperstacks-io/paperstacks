...
var (
	...
	ErrPaperAlreadyExists = errors.New("memory already exists")
)
...
func NewMemoryPaperRepository() *Repository {
	data := []domain.Paper{
		{
...
func (r *Repository) Create(_ context.Context, paper domain.Paper) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *Repository) ReadAll(_ context.Context) ([]domain.Paper, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *Repository) Read(_ context.Context, id string) (domain.Paper, error) {
	r.mu.RLock()
	defer r.mu.RUnlock()
...
func (r *Repository) Update(_ context.Context, id string, paper domain.Paper) error {
	r.mu.Lock()
	defer r.mu.Unlock()
